...
instance_mob_item_mapping = [
  ...
  ['Endless Tower', 10, [\
  (1059, 'Mistress', [(1413, .015), (518, 1.0), (2249, .025), (616, .30), (7018, .03), (985, 1), (16001, .01), (4132, .0003), (996, .15), (526, .40), (722, .30)]), \
  (1086, 'Golden Thief Bug', [(969, .30), (1524, .015), (2246, .025), (10016, .15), (714, .09), (985, .60), (984, .45), (4128, .0003), (2610, .20), (701, .10)]), \
  (1147, 'Maya', [(10006, .15), (2615, .02), (2234, .02), (639, .15), (7020, .03), (985, 1.0), (2005, .01), (8518, .027), (4146, .0003), (730, .20), (603, .30), (617, .20)]), \
  (1150, 'Moonlight Flower', [(1477, .05), (1234, .01), (1525, .015), (10008, .15), (638, .195), (985, .78), (1648, .01), (5360, .027), (4131, .0003)]), \
  (1159, 'Phreeoni', [(1223, .05), (1236, .015), (1014, 1.0), (2288, .03), (985, .87), (13047, .01), (8522, .027), (4121, .0003), (1008, .05), (730, .10), (1000, .40)]), \
  (1038, 'Osiris', [(617, .60), (1232, .015), (2235, .02), (1255, .06), (1009, .30), (5053, .015), (1285, .01), (4144, .0003), (603, .40), (608, .30), (751, .05)]), \
  (1312, 'Turtle General', [(1306, .0005), (7480, .006), (1417, .0009), (7070, 1.0), (1141, .008), (658, .0003), (5611, .001), (4305, .0003), (967, .55), (607, .15), (617, .20)]), \
  (1542, 'Incantation Samurai', [(607, 1.0), (985, 1.0), (999, 1.0), (1165, .0006), (1235, .024), (4263, .0003), (5096, .15), (13303, 1.0), (607, 1.0), (608, 1.0), (985, 1.0)]), \
  (1511, 'Amon Ra', [(5053, .015), (2615, .005), (7211, 1.0), (985, 1.0), (616, .12), (1552, .001), (607, .90), (4236, .0003), (607, .55), (608, .35), (732, .55)]), \
  (1630, 'Bacsojin', [(1020, 1.0), (603, 1.0), (12395, .015), (7165, .90), (7166, .30), (2700, .01), (2234, .001), (5464, .027), (4372,.0003)]), \
  (1039, 'Baphomet', [(1466, .04), (2256, .03), (1476, .005), (714, .15), (5160, .001), (985, 1.0), (984, 1.0), (4147, .0003)]), \
  (1046, 'Doppelganger', [(2317, .025), (1162, .022), (1168, .015), (2258, .035), (1411, .055), (985, 1.0), (984, .81), (4142, .0003)]), \
  (1087, 'Orc Hero', [(968, 1.0), (10018, .15), (1366, .015), (2106, .025), (1124, .10), (985, 1.0), (1387, .01), (4143, .0003)]), \
  (1190, 'Orc Lord', [(1363, .04), (2621, .04), (5007, .04), (1371, .04), (617, .30), (985, 1.0), (16000, .01), (4135, .0003), (968, .55), (617, .20)]), \
  (1272, 'Dark Lord', [(1615, .08), (5017, .055), (1237, .03), (2334, .03), (2507, .01), (985, 1.0), (2004, .01), (4168, .0003), (7005, .60), (5093, .05), (617, .20)]), \
  (1418, 'Evil Snake Lord', [(7169, 1.0), (10020, 1.0), (1471, .008), (5012, .008), (1474, .05), (7226, .27), (661, .60), (5364, .027), (4330, .0003 ), (607, .55), (608, .35), (985, .55)]), \
  (1658, 'General Egnigem Cenia', [(1162, .10), (644, 1.0), (603, 1.0), (1167, .10), (2320, .10), (2406, .10), (1130, .10), (4352, .0003), (617, .55), (603, .50), (732, .20)]), \
  (1785, 'Atroce', [(7563, 1.0), (608, .30), (2621, .02), (617, 1.0), (607, 1.0), (5123, .01), (1175, .01), (4425, .0003), (607, .55), (617, .50), (617, .50)]), \
  (1751, 'Valkyrie Randgris', [(7510, 1.0), (2357, .12), (2524, .15), (2421, .3), (2229, .5), (7024, .75), (2115, .16), (4407, .0003), (617, .55), (603, .50), (616, .20)]), \
  (1832, 'Ifrit', [(994, 1.0), (2677, .30), (12103, .0999), (13017, .005), (1471, .20), (1133, .20), (2345, .01), (5420, .10), (4430, .0003), (603, .55), (617, .50), (616, .20)]), \
  (1871, 'Fallen Bishop Hibram', [(523, 1.0), (1420, .05), (2677, .05), (1422, .05), (985, 1.0), (1614, .20), (18538, .04), (4441, .0003), (607, .55), (617, .50), (617, .50)]), \
  (1874, 'Beelzebub', [(7754, 1.0), (2423, .20), (1565, .20), (2000, .20), (2702, .20), (985, 1.0), (742, 1.0), (4145, .0003)]), \
  (1956, 'Naght Sieger', [(13412, .5), (13413, .5), (2542, .5), (5017, .90), (616, 1.0), (2514, .9), (7294, 1.0)]), \
  (1112, 'Drake', [(1127, .06), (1135, .015), (1128, .04), (5019, .035), (985, .096), (1189, .01), (5417, .024), (1127, .06)]) \
  ], EndlessTowerExternal]
]  
